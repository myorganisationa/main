...
class backupbuddy_deploy {
	 ...
	 *
	 */
	public function __construct( $destinationSettings, $existingState = '' ) {
	...
	public function start( $sourceInfo ) {
		...
		$this->_state['pushMediaFiles'] = $this->calculateMediaDiff( $sourceInfo['mediaSignatures'], $this->_state['remoteInfo']['mediaSignatures'] );
		$this->_state['pullMediaFiles'] = $this->calculateMediaDiff( $this->_state['remoteInfo']['mediaSignatures'], $sourceInfo['mediaSignatures'] );
